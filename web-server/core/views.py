...
from .serializers import DeviceTypeSerializer, DeviceSerializer, NotificationSourceSerializer, NotificationTypeSerializer, NotificationTemplateSerializer, NotificationSourceGroupSerializer, NotificationOptionSerializer, NotificationDelaySerializer, NotificationBulkEmailSerializer, TagSerializer
