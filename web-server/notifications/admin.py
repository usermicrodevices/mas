...
from .models import CustomAbstractModel, NotificationSource, NotificationType, NotificationTemplate, NotificationSourceGroup, NotificationOption, NotificationDelay, NotificationTask, NotificationBulkEmail

list_models = inspect.getmembers(sys.modules['core.models'], inspect.isclass)
exclude_classes = [CustomAbstractModel, NotificationSource, NotificationType, NotificationTemplate, NotificationSourceGroup, NotificationOption, NotificationDelay, NotificationTask, NotificationBulkEmail]
